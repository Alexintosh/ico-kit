    ...
    <section className={styles.root}>
      <div className={commonStyles.content}>
        ...
        <ol>
          ...
          <li>
            <h4>How can I trust I am sending to the official {CONF.tokenName} address?</h4>
            <p>
              Always triple check that you are on the official {CONF.tokenWebsite} URL (The
              official token sale page is {CONF.tokenWebsite}).
             </p>
          </li>
        </ol>
      </div>
